...
<div class="container-fluid footer bg-dark text-white py-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                ...
                <a class="text-white mb-2" href="register"><i class="fa fa-angle-right mr-2"></i>Registrations</a>
                ...
                <a class="text-white mb-2" href="see-opobo"><i class="fa fa-angle-right mr-2"></i>See Opobo</a>
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <p>Subscribe and follow our updates
            <p>
            <div class="w-100">
                <form>
                    <div class="input-group">
                        <input type="text" required class="form-control border-0" style="padding: 25px;" placeholder="Your Email">
